...
__year__ = "2015"
__description__ = "Converts an RXTE energy channel list to a list of real \
energy *boundaries* per detector energy channel."
...
chan_bin_file out_file", description="Converts an RXTE energy channel list to \
a list of real energy *boundaries* per detector energy channel.", epilog="All \
arguments are required.")
		
	parser.add_argument('ec_table_file', help='Txt table with real energy to \
absolute channel conversion for RXTE.')
	
	parser.add_argument('chan_bin_file', help='Txt table giving ')
