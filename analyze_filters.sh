...
# if (( $# != 2 )); then
#     echo -e "\t\tUsage: ./analyze_filters.sh <prop ID list> <filename prefix>"
#     exit
# fi
# propID_list=$1
# prefix=$2

propID_list="/Users/abigailstevens/Dropbox/Lists/GX339_propIDs.lst"
prefix="GX339-BQPO"
...
# 		echo "$filter_plot"
		...
		fcalc "$filter_file"[0] temp.fits NUM_PCU_ON MIN(V)
